...
def cornersHeuristic(state, problem):
    ...
    unvisitedCorners = [corner for corner in corners if corner not in Visited_Corners]
    while unvisitedCorners:
        distances = [(util.manhattanDistance(node, corner), corner) for corner in unvisitedCorners]
